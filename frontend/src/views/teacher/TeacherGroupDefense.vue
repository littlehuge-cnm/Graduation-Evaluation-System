...
async function handleSelectStudent(student) {
  ...
  try {
    ...
    const record = recordMap.value['答辩成绩']
    if (record) {
          ...
          <div v-if="selectedStudent" class="detail-panel">
            ...
            <div class="form-section">
              ...
              <el-form label-width="130px">
                ...
                <el-form-item label="答辩评语" required>
                  <el-input v-model="form.comment" type="textarea" :rows="8"
                    placeholder="请输入最终答辩评语，对报告内容、答辩过程、答辩小组评价进行综合评价" />
                </el-form-item>
              </el-form>
