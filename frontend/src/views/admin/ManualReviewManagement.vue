    ...
    <el-card class="table-card">
      <el-row :gutter="16">
        ...
        <el-col :span="19">
          <div v-if="selectedStudent" v-loading="loading" class="detail-panel" @scroll="handleScroll">
            ...
            <div id="section-progress" class="section">
              ...
              <div class="progress-horizontal">
                <div v-for="item in progressItems" :key="item" class="progress-item">
            ...
            <div id="section-task" class="section">
              ...
              <div class="doc-info-grid">
                ...
                <div class="doc-info-item">
                  ...
                  <span class="info-value">{{ getDoc('任务书')?.subjectCategory || '-' }}</span>
                </div>
                <div class="doc-info-item">
                  <span class="info-label">课题类型：</span>
                  <span class="info-value">{{ getDoc('任务书')?.subjectType || '-' }}</span>
                </div>
                <div class="doc-info-item">
                  <span class="info-label">新旧课题：</span>
                  <span class="info-value">{{ getDoc('任务书')?.subjectNewOld || '-' }}</span>
                </div>
              </div>
              <div v-if="getDoc('任务书')?.content" class="doc-content">
                <div class="content-text">{{ getDoc('任务书').content }}</div>
              </div>
          ...
          <div v-else class="empty-select">请选择左侧学生查看详情</div>
